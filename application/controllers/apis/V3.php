<?php
	...
	class V3 extends CI_Controller
	{
		...
		public function ShopCategoryList()
		{
          ...
          $output['res']="error";
          $output['msg']="error";
          $data=$this->db->get('tbl_shop_categories');
          if ($data->num_rows() > 0)
          {
            $output['res']="success";
            $output['msg']="Shop category list is found";
            $output['data']=$this->db->get('tbl_shop_categories')->result_array();
          }
          else{
            $output['res']='failled';
            $output['msg']="Shop category record was not Found";
          }
            echo json_encode([$output], JSON_UNESCAPED_UNICODE);
		}
		...
		public function SpiritualityList()
		{
          ...
          if ($data->num_rows() > 0)
          {
            ...
            $output['res']='failled';
            $output['msg']="Spirituality record was not Found";
          }
            echo json_encode([$output], JSON_UNESCAPED_UNICODE);
		}
