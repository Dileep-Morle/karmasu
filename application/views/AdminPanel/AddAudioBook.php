                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="<?php echo base_url("AdminPanel/ManageAudioBooks/Add"); ?>" method="post" enctype="multipart/form-data" id="addform" >
                                        ...
                                        <div class="form-group row">
                                            <label  class="col-sm-2 col-form-label">Educator <span class="text-danger">*</span></label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row d-none">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="icheck-material-success">
                                                    <input type="radio" id="freeradio" value="Free" name="abooktype" required checked />
