            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row pt-2 pb-2">
                        <div class="col-sm-9">
                            <h4 class="page-title"> Full Details of E-Book</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javaScript:void();">E-Books</a></li>
                                <li class="breadcrumb-item"><a href="javaScript:void();">Manage E-Books</a></li>
                        ...
                        <div class="col-sm-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <img src="../../../uploads/ebook/<?php echo $list[0]->banner; ?>" class="img-fluid"  style="max-height:200px;"/>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="checkbox"
                                            onchange="return ebookstatus(this,'tbl_ebook','id','<?php echo $list[0]->id;?>','apprstatus')" <?php if ($list[0]->apprstatus == "true") {
                                                echo "checked";
                                            } ?> class="js-switch"  data-color="#eb5076" data-size="small">
                                            <a href="<?php echo base_url("AdminPanel/ManageEBooks/Edit/".$list[0]->id) ?>"
                                            class="btn btn-sm btn-primary waves-effect waves-light">
                                            <i class="fa fa fa-edit"></i>  </a>
                                            <a href="javascript:void(0);"
                                            class="btn btn-sm btn-danger waves-effect waves-light"
                                            onclick="return ebookdelete(this,'tbl_ebook','id','<?php echo $list[0]->id;?>','ebook','logo,banner,sample,ebbok')">
                                            <i class="fa fa-trash"></i> </a>
                                            <!--
                                                <a href="<?php echo base_url("../uploads/ebook/".$list[0]->ebook) ?>"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                                        ...
                                        <li class="nav-item">
                                            <a href="javascript:void();" data-target="#sample" data-toggle="pill" class="nav-link ">Sample Page</a>
                                        </li>
                                    </ul>
                                                        ...
                                                        <?php
                                                            ...
                                                            if(count($topicList)){
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a target="_blank" href="<?php echo base_url('pdf_viewer/web/viewer.php?url='.base_url('uploads/topic/'.$item->topic));?>">View PDF</a>
                                                                    </td>
                                                                    <td>
                    ...
                    <div class="modal fade" id="AddModal">
                        <div class="modal-dialog">
                            <div class="modal-content border-primary">
                                ...
                                <form action="<?php echo base_url("AdminPanel/ManageEBooks/AddTopic/".$list[0]->id); ?>" method="post"
                                enctype="multipart/form-data" id="addform">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Topic (PDF)<span class="text-danger">*</span></label>
                                            <input type="file" class="form-control" name="topic" required placeholder="Topic Link"  accept="application/pdf">
